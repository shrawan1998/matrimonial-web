					...
					<div class="col_3">
						...
						<div class="col-sm-8 row_1">
							...
							if(isset($_GET["empty"])){
								...
								?>
									<div class="alert alert-danger">
										<h3>Password Mismatched</h3>
									</div>
								<?php
							}
							else if(isset($_GET["incorrect_pass"])){
								?>
									<div class="alert alert-danger">
							...
							<form method="post" action="pass.php">
								<div class="form-group">
								  ...
								  <input type="password" id="edit-pass" name="cpass" size="60" maxlength="128" class="form-text required" required>
								</div>
								<div class="form-group">
								  <label for="edit-pass">New Password <span class="form-required" title="This field is required.">*</span></label>
								  <input type="password" id="edit-pass" name="npass" size="60" maxlength="128" class="form-text required" required>
								</div>
								<div class="form-group">
								  <label for="edit-pass">Retype New Password <span class="form-required" title="This field is required.">*</span></label>
								  <input type="password" id="edit-pass" name="repass" size="60" maxlength="128" class="form-text required" required>
								</div>
								<div class="form-actions">
									<input type="submit" id="edit-submit" name="op" value="Update" class="btn_1 update">
								</div>
							</form>
						</div>
