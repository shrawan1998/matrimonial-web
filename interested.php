		...
		<div class="grid_3">
		  <div class="container">
		   ...
		   <div class="col-md-9 profile_left1">
			...
			<button class="btn btn-info" id="interested">Interest shown by you</button>&nbsp;&nbsp;<button class="btn btn-info" id="user_interested">Interested in you</button>
			<div id="record">
			<?php
				$flag=0;
				$code="";
				...
				$rs=mysqli_query($conn,"select * from details where code IN(select code from interested where email='$email') OR email IN(select email from interested where code='$code')");
